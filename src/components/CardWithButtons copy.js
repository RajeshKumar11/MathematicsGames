...
//   useEffect(() => {
//     // if (cardIndex != cardSelectedIndex) {
//     if (cardIndex === resetCardIndex - 1 || cardIndex === resetCardIndex + 1) {
      
//       // Implement your logic to reload or update the card content
//       // For example, fetching new data or updating state
...
//   const handleWordPress = (index, word) => {
//     setCurrentWordIndex(index);
//     // Character wise speaking
//     if (isCharSpeaking) {
//       // Iterating over characters to triggering speaking and highlighting characters
...
//             setWordClickedIndex(index);
//             setCharClickedIndex(charIndex);
//           }
//         }, 1000 * charIndex)
//       }
//       // Triggering word speaking on char wise speaking completion
//       setTimeout(() => {
//         setCharClickedIndex(-1);
//         setIsSpeaking(true);
//         setWordClickedIndex(index);
//         setSepakingText(word);
//       }, 1000 * word.length);
//       // In case of char speaking holding to highlight the word till speaking is done
//       if (isCharSpeaking) {
//         setTimeout(() => {
//           setWordClickedIndex(-1);
//         }, 1000 * (word.length + 2));
...
//       setWordClickedIndex(index);
//       setSepakingText(word);
//       // Handle additional actions here based on the selected word
//     }
//   };
...
//   return (
//     <View style={[styles.card, { width: reducedWidth, height: reducedHeight }]}>
//       {isSpeaking ?
...
//           {autoPlay ?
//             <Text style={[
//               styles.buttonCharacter]}>Pause</Text>
//             :
//             <Text style={[
//               styles.buttonCharacter]}>Play</Text>
//           }
//         </TouchableOpacity>
//       </View>
